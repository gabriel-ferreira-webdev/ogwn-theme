      ...
      <div class="header-flex container">
        ...
        <?php echo get_theme_mod( 'my_site_logo_id' );?>
          ...
          <form action="/" method="get" id="searchform" class="header-searchform">
            <input type="checkbox" name="searchCb" id="searchCb" onclick="noScrollOnMenuOpen(this)">
            <label id="searchCbLabel"for="searchCb">
        ...
        <label for="searchCb" class="fade" id="fadesearch"></label>
